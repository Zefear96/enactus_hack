...
const ReviewThanks = () => {
    ...
    return (
        <div className='flex justify-center items-center m-auto my-10'>
            <div className={` bg-greybase w-2/5 rounded-3xl md:w-3/5 lg:w-2/4 max-sm:w-4/5`} style={{ boxShadow: 'inset -4px 0px 4px rgba(117, 117, 117, 0.1), inset 4px 0px 4px rgba(117, 117, 117, 0.1), inset 0px -4px 4px rgba(117, 117, 117, 0.1), inset 0px 4px 4px rgba(117, 117, 117, 0.1)' }}>
