		...
		<div className="flex w-11/12 m-auto ">
			...
			<div className="flex w-2/4 mx-auto my-10">
				<div className="mx-auto w-11/12">
					<Title ta="center" fw={700} my="40px" fz="30px">
						Личные данные
					</Title>
					...
					<Text ta="center">
						<b>Эл. почта:</b> {currentUser.email}{" "}
					</Text>
					<Text ta="center">
						<b>Номер телефона:</b> {currentUser.phone_number}{" "}
					</Text>
					<Group position="right" mt="md">
						<button
							type="submit"
							className=" bg-yellowlogin w-1/2 mx-auto h-12 rounded-lg my-1 text-bluelogin"
						>
