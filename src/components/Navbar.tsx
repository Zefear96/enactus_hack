				...
				<div className=" w-full  flex items-center">
					...
					<div className="flex mx-auto justify-center">
						<Menu as="div" className="relative inline-block text-left mx-auto">
							...
							>
								<Menu.Items className="absolute right-[-1/2] mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
									{services.map((item) => (
					...
					<div className="flex mx-auto justify-center text-lg mt-5">
						<Menu as="div" className="relative inline-block ">
							...
							<Transition
								...
								leaveTo="transform opacity-0 scale-95"
							>
								<Menu.Items className="absolute right-[1/4] mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
									{services.map((item) => (
										<div className="px-1 py-1" key={item.type}>
											<Menu.Item>
												{({ active }) => (
