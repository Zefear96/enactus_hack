...
import { useFetchHostels } from "@/services/commercials/fetchCommCategories";

const ListHostels = () => {
	const [data] = useFetchHostels();
	console.log(data);

	return (
		<div>
			<div className=" flex justify-between flex-wrap w-full mx-auto my-7 max-sm:flex-col">
				{data.map((item) => (
			...
			<div
				style={{
					backgroundImage: "url(" + "https://i.ibb.co/W30Mqf7/yourad.png" + ")",
					width: "100%",
					height: "500px",
					margin: "auto",
					display: "flex",
