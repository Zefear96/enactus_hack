...
const profileFormSchema = z.object({
    ...
    profile_image: (typeof window !== "undefined" ? z.instanceof(File) : z.any())
        .refine((file) => {
        ...
        <FocusTrap active>
            <form onSubmit={form.onSubmit(handleSubmit)} className="m-auto w-11/12">
                ...
                <div className="flex items-end justify-center my-10">
                    ...
                    {/* {form.values.profile_image ? <><Avatar src={form.values.profile_image} style={{ borderRadius: '50%', border: '1px solid #4526FF' }} size="xl" />   <IconPencil color='rgba(0, 0, 0, 0.6)' className='-ml-3' onClick={() => setFileOpen(true)} /></> : form.values.name ? <><Avatar src={null} color="primary" alt={form.values.name} style={{ borderRadius: '50%', border: '1px solid #4526FF' }} size="xl" /> <IconPencil color='rgba(0, 0, 0, 0.6)' className='-ml-3' onClick={() => setFileOpen(true)} /></> : <><Avatar size="xl" style={{ borderRadius: '50%', border: '1px solid #4526FF' }} />  <IconPencil color='rgba(0, 0, 0, 0.6)' className='-ml-3' onClick={() => setFileOpen(true)} /></>} */}
